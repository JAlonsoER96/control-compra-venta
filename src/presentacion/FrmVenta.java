...
public class FrmVenta extends javax.swing.JInternalFrame {
            ...
            public void setValueAt(Object aValue, int row, int column) {
                ...
                try {
                    ...
                    if (cantD > stockD) {
                        ...
                        errorMesagge("La cantidad no puede superar al stock, el máximo de productos permitidos son: " + stockD);
                    }
    ...
    public void agregarDet(String id, String codigo, String nombre, String stock, String precio, String descuento) {
        String idTem;
    ...
    //Obtiene los ultimos digitos para generar el comprobante
    private void obtenerNumero() {
        String tipoComprobante = (String) comboCompro.getSelectedItem();
        ...
        txtSerie.setText(serieComprobante);
        if (numComprobante.equals("")) {
            txtNumero.setText("");
        } else {
            int num;
            num = Integer.parseInt(numComprobante) + 1;
            txtNumero.setText(Integer.toString(num));
        }
    }
    ...
    private void initComponents() {
        ...
        btnSelClien = new javax.swing.JButton();
        ...
        btnReportCompro.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        txtIdClient.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N

        txtNomClien.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N

        btnSelClien.setText("...");
        btnSelClien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSelClienActionPerformed(evt);
            }
        });
            ...
            .addGroup(panelManteCatLayout.createSequentialGroup()
                .addGroup(panelManteCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelManteCatLayout.createSequentialGroup()
                        ...
                        .addGroup(panelManteCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelManteCatLayout.createSequentialGroup()
                                .addComponent(txtIdClient, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtIdClient.getText().length() == 0) {
            JOptionPane.showMessageDialog(this, "Debe seleccionar un cliente.", "Sistema", JOptionPane.WARNING_MESSAGE);
            btnSelClien.requestFocus();
            return;
        }
        ...
        String resp;
        //Guardar
        resp = this.CONTROL.insert(Integer.parseInt(txtIdClient.getText()), (String) comboCompro.getSelectedItem(), txtSerie.getText(), txtNumero.getText(), Double.parseDouble(txtImpuesto.getText()), Double.parseDouble(txtTotal.getText()), modeloDetalles);
        if (resp.equals("OK")) {
    ...
    private void btnDesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesactivarActionPerformed
        if (tablaListIngreso.getSelectedRowCount() == 1) {
            ...
            if (JOptionPane.showConfirmDialog(this, "¿Deseas anular la venta: " + comprobante + " " + serie + "-" + numero + "?: ", "Anular", JOptionPane.YES_NO_OPTION) == 0) {
    ...
    private void btnSelClienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelClienActionPerformed
        FrmSeleccionarCliente frm = new FrmSeleccionarCliente(contenedor, this, true);
        frm.toFront();
    }//GEN-LAST:event_btnSelClienActionPerformed
    ...
    private void txtCodigoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyReleased
        if (txtCodigo.getText().length() > 0) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                art = CONTROL.obtenerPorCodVenta(txtCodigo.getText());
                if (art == null) {
                    errorMesagge("El codigo no existe");
                } else {
                    //String id, String codigo, String nombre, String stock,String precio, String descuento
                    agregarDet(Integer.toString(art.getIdarticulo()), art.getCodigo(), art.getNombre(), Integer.toString(art.getStock()), Double.toString(art.getPrecio_venta()), "0");
                }
            }
        } else {
    ...
    private void btnDetallesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetallesActionPerformed
        if (tablaListIngreso.getSelectedRowCount() == 1) {
            ...
            txtIdClient.setText(idPro);
            txtNomClien.setText(nombrePro);
    ...
    private javax.swing.JButton btnSelClien;
