...
public class FrmUsuario extends javax.swing.JInternalFrame {
    ...
    public FrmUsuario() {
        initComponents();
        this.CONTROL = new ControlUsuario();
        this.paginar();
        this.listar("",false);
    ...
    private void ocultarColumnas(){
        this.tablaListadoUser.getColumnModel().getColumn(1).setMaxWidth(0);
        this.tablaListadoUser.getColumnModel().getColumn(1).setMinWidth(0);
        this.tablaListadoUser.getTableHeader().getColumnModel().getColumn(1).setMaxWidth(0);
        this.tablaListadoUser.getTableHeader().getColumnModel().getColumn(1).setMinWidth(0);
        //Ocultar Clave
        this.tablaListadoUser.getColumnModel().getColumn(9).setMaxWidth(0);
        this.tablaListadoUser.getColumnModel().getColumn(9).setMinWidth(0);
        this.tablaListadoUser.getTableHeader().getColumnModel().getColumn(9).setMaxWidth(0);
        this.tablaListadoUser.getTableHeader().getColumnModel().getColumn(9).setMinWidth(0);
    }
    ...
    private void listar(String text, boolean paginar) {
        ...
        if(paginar = true){
            ...
            tablaListadoUser.setModel(this.CONTROL.listar(text,this.totalPorPagina,this.numPagina));
        }else{
            tablaListadoUser.setModel(this.CONTROL.listar(text,this.totalPorPagina,1));
        }
        
        TableRowSorter orden = new TableRowSorter(tablaListadoUser.getModel());
        tablaListadoUser.setRowSorter(orden);
    ...
    private void initComponents() {
        ...
        tablaListadoUser = new javax.swing.JTable();
        ...
        tablaListadoUser.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        tablaListadoUser.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaListadoUser);
        ...
        comboRol.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        comoTipoDoc.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "INE", "Cedúla", "Pasaporte" }));
                ...
                .addGroup(panelManteCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelManteCatLayout.createSequentialGroup()
                        .addGroup(panelManteCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txtNewArtName, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(comboRol, javax.swing.GroupLayout.Alignment.LEADING, 0, 308, Short.MAX_VALUE)
                            .addComponent(comoTipoDoc, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(28, 28, 28)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtMail.getText().length()==0 ||  txtMail.getText().length()>50) {
            JOptionPane.showMessageDialog(this, "El campo email es obligatorio", "Sistema", JOptionPane.WARNING_MESSAGE);
            txtMail.requestFocus();
            return;
        }
        if (txtPwd.getText().length()==0 || txtPwd.getText().length()>64) {
            JOptionPane.showMessageDialog(this, "El campo contraseña es obligatorio", "Sistema", JOptionPane.WARNING_MESSAGE);
            txtPwd.requestFocus();
            return;
        }
        ...
        if (this.accion.equals("editar")) {
            //Editar
            String valorPass = new String(txtPwd.getPassword());
            Rol seleccionado = (Rol)comboRol.getSelectedItem();
            resp = this.CONTROL.update(Integer.parseInt(lblNumRegistro.getText()),seleccionado.getIdrol(),txtNewArtName.getText(),this.emailAnte,(String)comoTipoDoc.getSelectedItem(), txtNumDoc.getText(),txtDir.getText(),txtTelefono.getText(),txtMail.getText(),txtPwd.getText());
            if (resp.equals("OK")) {
            ...
            String valorPass = new String(txtPwd.getPassword());
            Rol seleccionado = (Rol)comboRol.getSelectedItem();
            resp = this.CONTROL.insert(seleccionado.getIdrol(),txtNewArtName.getText(),(String)comoTipoDoc.getSelectedItem(),txtNumDoc.getText(),txtDir.getText(),txtTelefono.getText(),txtMail.getText(),txtPwd.getText());
            if (resp.equals("OK")) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tablaListadoUser.getSelectedRowCount() == 1) {
            String id = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 0));
            int idRol = Integer.parseInt(String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 1)));
            String rolAnte = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 2));
            String nombre = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 3));
            String tipo_documento = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 4));
            String num_documento = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 5));
            String direccion = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 6));
            String telefono =String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 7));
            String email = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 8));
            String password = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 9));
            this.emailAnte = email;            
            lblNumRegistro.setText(id);
            Rol seleccionado = new Rol(idRol, rolAnte);
            comboRol.setSelectedItem(seleccionado);
    ...
    private void btnDesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesactivarActionPerformed
        if (tablaListadoUser.getSelectedRowCount() == 1) {
            String id = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 0));
            String nombre = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 3));
            if (JOptionPane.showConfirmDialog(this, "¿Deseas desactivar el usuario: "+nombre+ "?: ","Desactivar", JOptionPane.YES_NO_OPTION)==0) {
    ...
    private void btnActivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActivarActionPerformed
        if (tablaListadoUser.getSelectedRowCount() == 1) {
            String id = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 0));
            String nombre = String.valueOf(tablaListadoUser.getValueAt(tablaListadoUser.getSelectedRow(), 3));
            if (JOptionPane.showConfirmDialog(this, "¿Deseas activar el usuario: "+nombre+ "?: ","Activar", JOptionPane.YES_NO_OPTION)==0) {
    ...
    private javax.swing.JTable tablaListadoUser;
