 ...
 */
public class FrmSeleccionarProveedor extends javax.swing.JDialog {
    ...
    /**
     * Creates new form FrmSeleccionarProveedor
     */
    public FrmSeleccionarProveedor(java.awt.Frame parent, FrmIngreso frm,boolean modal) {
        super(parent, modal);
        initComponents();
...
private void paginar(){
 ...
 private void listar(String text, boolean paginar) {
        ...
        if(paginar = true){
            ...
            tablaListProvee.setModel(this.CONTROL.listarTipo(text,this.totalPorPagina,this.numPagina,"Proveedor"));
        }else{
            tablaListProvee.setModel(this.CONTROL.listarTipo(text,this.totalPorPagina,1,"Proveedor"));
        }
 ...
 private void limpiar() {
    ...
    private void initComponents() {
        ...
        btnSelProv.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        btnSelProv.setText("Seleccionar");
                ...
                .addGroup(panelListadoCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelListadoCatLayout.createSequentialGroup()
                        ...
                        .addGroup(panelListadoCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnSelProv, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (this.accion.equals("editar")) {
            //Editar
            resp = this.CONTROL.update(Integer.parseInt(lblNumRegistro.getText()),"Proveedor",txtNewArtName.getText(),nombreAnte,(String)comoTipoDoc.getSelectedItem(),txtNumDoc.getText(),txtDir.getText(),txtTelefono.getText(),txtMail.getText());
            if (resp.equals("OK")) {
            ...
            //Guardar
            resp = this.CONTROL.insert("Proveedor",txtNewArtName.getText(),(String)comoTipoDoc.getSelectedItem(),txtNumDoc.getText(),txtDir.getText(),txtTelefono.getText(),txtMail.getText());
            if (resp.equals("OK")) {
    ...
    private void btnSelProvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelProvActionPerformed
        if(tablaListProvee.getSelectedRowCount()==1){
            String id = String.valueOf(tablaListProvee.getValueAt(tablaListProvee.getSelectedRow(),0));
            String nombre =String.valueOf(tablaListProvee.getValueAt(tablaListProvee.getSelectedRow(),2));
            vista.txtIdProv.setText(id);
            vista.txtNomProv.setText(nombre);
            this.dispose();
        }else{
            errorMesagge("Debe seleccionar al menos un proveedor");
        }
