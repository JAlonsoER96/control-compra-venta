 ...
 */
public class FrmSeleccionarCliente extends javax.swing.JDialog {
     ...
     */
    public FrmSeleccionarCliente(java.awt.Frame parent, FrmVenta frm,boolean modal) {
        super(parent, modal);
        initComponents();
...
private void paginar(){
 ...
 private void listar(String text, boolean paginar) {
        ...
        if(paginar = true){
            ...
            tablaListProvee.setModel(this.CONTROL.listar(text,this.totalPorPagina,this.numPagina));
        }else{
            tablaListProvee.setModel(this.CONTROL.listar(text,this.totalPorPagina,1));
        }
 ...
 private void limpiar() {
    ...
    private void initComponents() {
                ...
                .addGroup(panelListadoCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelListadoCatLayout.createSequentialGroup()
                        ...
                        .addGroup(panelListadoCatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnSeleccionar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 1228, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if(tablaListProvee.getSelectedRowCount()==1){
            String id = String.valueOf(tablaListProvee.getValueAt(tablaListProvee.getSelectedRow(),0));
            String nombre =String.valueOf(tablaListProvee.getValueAt(tablaListProvee.getSelectedRow(),2));
            vista.txtIdClient.setText(id);
            vista.txtNomClien.setText(nombre);
            this.dispose();
        }else{
